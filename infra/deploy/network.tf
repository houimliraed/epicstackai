...
# internet access for inboud access to the ALB
...
## endpoint to allow ECS to access ECR , Cloud Watch and Systems Manager

resource "aws_security_group" "endpoint_access" {
  name        = "${local.prefix}-endpoint-access"
  description = "Allow access to AWS endpoints"
  vpc_id      = aws_vpc.main.id
